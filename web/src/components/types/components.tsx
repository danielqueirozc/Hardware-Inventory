...
import { ItemMobile } from "../mobile/item-mobile";
    ...
    <div className="h-full bg-gray-200">
       <header className="flex items-center justify-items-start bg-green px-10 py-4 md:py-8">
        <div className="flex items-center justify-center gap-4">
          ...
          <span className="font-semibold text-white md:text-xl">Componentes</span>
        </div>
      </header>

      <div className="flex flex-col px-10 lg:px-24 py-6 h-full">
