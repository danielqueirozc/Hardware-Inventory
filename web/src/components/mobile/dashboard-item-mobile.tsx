...
export function DashboardItemMobile() {
    ...
    <div className="h-auto bg-gray-200">
       <header className="flex items-center justify-items-start bg-green px-10 py-4 md:py-8">
        <div className="flex items-center justify-center gap-4">
          ...
          <span className="font-semibold text-white md:text-xl">Computador</span>
        </div>
      </header>

      <div className="flex flex-col px-10 py-6 h-full md:mt-8">
